...
public class DoorPermissionWindow extends PermissionWindow {
    ...
    public void init(Player player, InventoryContents inventoryContents) {
        inventoryContents.set(SLOT_DOOR_OPEN, buildPermissionSwitch(ProtectionPermission.CONTAINER_OPEN));
    ...
    public static SmartInventory getInventory(Protection protection, UUID memberId) {
        return SmartInventory.builder()
                .id("doorPermissionWindow")
                .provider(new DoorPermissionWindow(protection, memberId))
                .size(1, 9)
